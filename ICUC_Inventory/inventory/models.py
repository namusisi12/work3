...
class Product (models.Model):
    ...
    unit_price=models.IntegerField(max_length=300,null=True)
    sale_price=models.IntegerField(max_length=300,null=True)
    available_stock=models.IntegerField(max_length=300,null=True)
...
class Transaction (models.Models):
   ...
   transaction_amount=models.IntegerField(max_length=200,null=True)
